...
const Portraitbenefits : React.FC<Props>= (Props) => {     

      
  return (
       <>
       <div className='benefit-div'>
           <div className='port-benefit-emoji'> 
                   <Image src={benefit} alt='student' className='benefit-image'/>   
           </div>
           <div className='port-benefit-heading'>
                 <p className='benefit-p'>{Props.benefit_heading}</p>
           </div> 
           <div className='port-benefit-body'>
...
export default Portraitbenefits